export default class CalculatingController {
  constructor(calculating) {
    ...
    this.genderBox = this.calculatingField.querySelector('.calculating-gender-box');
    this.paramsBox = this.calculatingField.querySelector('.calculating-params-box');
    this.activBox = this.calculatingField.querySelector('.calculating-activ-box');
    this.totalBox = this.calculatingField.querySelector('.calculating-total-box');
    this.gender = this.genderBox.querySelector('.calculating-gender-box-content');
    this.params = this.paramsBox.querySelector('.calculating-params-box-content');
